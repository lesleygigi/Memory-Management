...
int main() {
    ...
    char *ptr[4];
    assert((ptr[0] = Mem_Alloc(1, M_FIRSTFIT)) != NULL);
    assert((ptr[1] = Mem_Alloc(12, M_FIRSTFIT)) != NULL);
    assert((ptr[2] = Mem_Alloc(31, M_FIRSTFIT)) != NULL);
    assert((ptr[3] = Mem_Alloc(4, M_FIRSTFIT)) != NULL);
