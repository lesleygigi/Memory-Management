...
int main() {
    ...
    ptr[0] = Mem_Alloc(880, M_FIRSTFIT);
    assert(ptr[0] != NULL);

    ptr[1] = Mem_Alloc(880, M_FIRSTFIT);
    assert(ptr[1] != NULL);

    ptr[2] = Mem_Alloc(880, M_FIRSTFIT);
    assert(ptr[2] != NULL);

    ptr[3] = Mem_Alloc(880, M_FIRSTFIT);
    assert(ptr[3] != NULL);

    assert(Mem_Alloc(880, M_FIRSTFIT) == NULL);
    ...
    ptr[2] = Mem_Alloc(free - HEADER, M_FIRSTFIT);
    assert(ptr[2] != NULL);
